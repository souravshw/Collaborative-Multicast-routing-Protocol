...
public class Message implements Comparable<Message> {
	...
	private DTNHost responseTo;
	
	private HostGroup to;
	...
	private int initTtl;
	/**Location where the message is being created */
	private Coord location;
	/**The priority being assigned to the message */
	 ...
	 */
	public Message(DTNHost from, HostGroup to,int priority, String id, int size, Coord location) {
		this.from = from;
		this.to = to;
		this.id = id;
		this.size = size;
	...
	public Message replicate() {
		Message m = new Message(from, to,priority, id, size,location);
		m.copyFrom(this);
		return m;
	}
